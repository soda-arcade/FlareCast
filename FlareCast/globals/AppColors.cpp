...
void AppColors::init() {
	...
	positive = ImVec4(0.55f, 0.75f, 0.55f, 1.00f);
	negative = ImVec4(0.80f, 0.45f, 0.45f, 1.00f);
	...
	background = ImVec4(0.1176f, 0.1098f, 0.1059f, 1.00f);

	panelBackground = ImVec4(0.19f, 0.18f, 0.17f, 1.00f);
