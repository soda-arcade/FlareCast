...
class CommandVIP : public ACommand
{
public:

	std::string usage = "Usage: !vip <username>\nExample: !vip TriangleHero\0";
	 ...
	 * @param guestHistory
	 */
	CommandVIP(const char* msg, Guest& sender, GuestList& guests, GuestDataList& guestHistory)
