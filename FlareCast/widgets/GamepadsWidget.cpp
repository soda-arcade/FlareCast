...
bool GamepadsWidget::render(bool& showWindow) {
    ...
    ImGui::BeginChild("gamepad options", ImVec2(size.x, 50), false, ImGuiWindowFlags_NoScrollbar);
    ImGui::SetCursorPos(ImVec2(0, 0));
    ImDrawList* drawList = ImGui::GetWindowDrawList();
    pos = ImGui::GetCursorScreenPos();
    drawList->AddRectFilled(pos, ImVec2(pos.x + size.x, pos.y + 46), ImGui::ColorConvertFloat4ToU32(ImVec4(0, 0, 0, 0.1)), 8, ImDrawFlags_RoundCornersBottom);
    ImGui::SetCursorPos(ImVec2(0, 0));
    ...
    for (size_t i = 0; i < _gamepads.size(); ++i) {
        ...
        ImGui::BeginChild(child.c_str(), ImVec2(size.x - 20, height));
            ...
            size = ImGui::GetContentRegionAvail();
            ImDrawList* drawList = ImGui::GetWindowDrawList();
            drawList->AddRectFilled(pos, ImVec2(pos.x + size.x, pos.y + height), ImGui::ColorConvertFloat4ToU32(ImVec4(0, 0, 0, 0.1)), 8, ImDrawFlags_RoundCornersAll);
