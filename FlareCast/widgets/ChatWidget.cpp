...
bool ChatWidget::render(bool& showWindow) {
    ...
    startFooter();
        ...
        if (ToggleIconButtonWidget::render(
            ...
            AppColors::buttonPrimary, AppColors::buttonPrimary,
            ImVec2(20, 20)
        )) {
            sendMessage();
        }
...
bool ChatWidget::renderTopBar(bool& isWindowLocked, bool& isClearChat) {
    ...
    if (!isDeletingChat) {
        if (IconButton::render(AppIcons::trash, AppColors::buttonSecondary, ImVec2(20, 20))) {
            //isDeletingChat = true;
            isClearChat = true;
            result = true;
        }
        ...
        btnNo = IconButton::render(AppIcons::no, AppColors::negative, ImVec2(20, 20));
        ImGui::SameLine();
        btnYes = IconButton::render(AppIcons::yes, AppColors::positive, ImVec2(20, 20));
